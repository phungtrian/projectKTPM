...
//    @FXML void updateFlight(ActionEvent event) {
//        
//        this.btUpdate.setOnAction(obj -> {
//            
//        });
//        
...
//                    cbNoidi.setItems(FXCollections.observableList(s.getLocatetById(f.getId())));
//                    this.cbNoidi.getSelectionModel().select(a);
                    
//                    cbNoiden.setItems(FXCollections.observableList(s.getAirports()));
//                    this.cbNoiden.getSelectionModel().select(a);
//                    this.cbNoidi.getSelectionModel().select(a);
//                    this.cbNoiden.getSelectionModel().select(a);
//                    this.cbNoidi.setItems(FXCollections.observableList(s.getAirports()));
//                    this.cbNoiden.setItems(FXCollections.observableList(s.getAirports()));
